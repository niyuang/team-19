...
CREATE TABLE users(
	...
	openID              VARCHAR(200),
	Role                enum('patient','admin','hcp','uap','er','tester','pha', 'lt','nutritionist') NOT NULL DEFAULT 'admin',
...
CREATE TABLE personnel(
	...
	role enum('admin','hcp','uap','er','tester','pha', 'lt', 'nutritionist') NOT NULL default 'admin',
...
CREATE TABLE patientfooddiary(
	MID			BIGINT unsigned,
	ldate		DATE NOT NULL,
	meal		enum('Breakfast','Lunch','Dinner','Snack') NOT NULL DEFAULT 'Breakfast',
	food		VARCHAR(200) DEFAULT '',
	servings	DOUBLE NOT NULL,
	cals		DOUBLE NOT NULL default '0', 
