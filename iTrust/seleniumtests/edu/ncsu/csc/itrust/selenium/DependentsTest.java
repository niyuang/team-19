...
public class DependentsTest extends iTrustSeleniumTest {
	...
	public void testAddDependentPatient() throws Exception {
		...
		elem.sendKeys("Marley");
		elem = driver.findElement(By.name("email"));
		elem.sendKeys("bmarley@test.com");
		elem = driver.findElement(By.name("isDependent"));
		elem.toggle(); // Check the box.
		elem = driver.findElement(By.name("repId"));
		elem.sendKeys("102");
		elem.submit();

		// Make sure the text displays.
		List<WebElement> list = driver.findElements(By
				.xpath("//*[contains(text(),'" + "successfully added" + "')]"));
	...
	public void testViewRequestedRecordsForDependent() throws Exception {
		...
		assertEquals("iTrust - Categorize Food Diary", driver.getTitle());
	}
