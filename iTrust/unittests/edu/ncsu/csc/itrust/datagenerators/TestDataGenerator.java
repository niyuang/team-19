...
public class TestDataGenerator {
	...
	//Added by Jay
	public void patient0DerekMorgan() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient0DerekMorgan.sql");
	}
	
	//Added Since HW3P1
	public void patient0JenniferJareau() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient0JenniferJareau.sql");
	}
	
	//Added since HW3P1
	public void patient0AaronHotchner() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient0AaronHotchner.sql");
	}
	
	//Added since HW3P3
	public void patient0EmilyPrentiss() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient0EmilyPrentiss.sql");
	}
	...
	*/
	...
	public void standardData() throws FileNotFoundException, IOException, SQLException {
		...
		//Jay added
		patient0DerekMorgan(); //Newly Added
		patient0JenniferJareau(); //Newly added
		patient0AaronHotchner(); //Newly added
		hcp11(); //New for HW3P1
		
		//Added new acceptance scenario for HW3P3
		patient0EmilyPrentiss(); //Newly Added
